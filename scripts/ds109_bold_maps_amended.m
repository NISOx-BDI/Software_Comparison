...
% FSL files
fsl_contrast_file = fullfile(study_dir, 'FSL', 'LEVEL2_amended', 'group.gfeat', 'cope1.feat', 'stats', 'cope1.nii.gz');
fsl_mat_file = fullfile(study_dir, 'FSL', 'LEVEL1_amended', 'sub-01', 'run-01.feat', 'design.mat');
...
X = spm_read_vols(V);
Binout = V(1);
Binout.fname = fullfile(bold_dir, 'fsl_bold_amended.nii');
