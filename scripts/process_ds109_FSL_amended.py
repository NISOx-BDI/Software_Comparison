...
level1_dir = os.path.join(fsl_dir, 'LEVEL1_amended')
level2_dir = os.path.join(fsl_dir, 'LEVEL1_amended')
level3_dir = os.path.join(fsl_dir, 'LEVEL2_amended', 'group')
perm_dir = os.path.join(fsl_dir, 'LEVEL2_amended', 'permutation_test')
...
run_level_fsf = os.path.join(cwd, 'lib', 'template_ds109_FSL_level1_amended.fsf')
