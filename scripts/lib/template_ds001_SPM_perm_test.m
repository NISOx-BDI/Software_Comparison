...
matlabbatch{1}.spm.tools.snpm.des.OneSampT.ST.ST_U = 0.01;
...
matlabbatch{3}.spm.tools.snpm.inference.WriteFiltImg.name = 'SnPM_pos_filtered';
...
matlabbatch{4}.spm.tools.snpm.inference.Thr.Clus.ClusSize.CFth = NaN;
...
matlabbatch{4}.spm.tools.snpm.inference.WriteFiltImg.name = 'SnPM_neg_filtered';
