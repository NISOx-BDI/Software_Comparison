...
randomise -i contrasts -o OneSampT -d /storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds001/FSL/LEVEL2/permutation_test/../group.gfeat/design.mat -t /storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds001/FSL/LEVEL2/permutation_test/../group.gfeat/design.con -x -c `ptoz 0.01` -n 10000 -m /storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds001/FSL/LEVEL2/permutation_test/../group.gfeat/cope1.feat/mask.nii.gz
