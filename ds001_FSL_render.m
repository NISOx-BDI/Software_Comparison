function ds001_FSL_render
    ...
    batch = ds001_FSL_batch(POS_EXCURSION_SET_FILE, NEG_EXCURSION_SET_FILE, SPM_SURFACE_FILE);
    spm_jobman('run', batch)
end

function x = ds001_FSL_batch(POS_EXCURSION_SET_FILE, NEG_EXCURSION_SET_FILE, SPM_SURFACE_FILE)
	%-----------------------------------------------------------------------
