...
randomise -i contrasts -o OneSampT_pos -1 -x -c `ptoz 0.005` -n 10000 -m /storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds109/FSL/LEVEL2/permutation_test/../group.gfeat/cope1.feat/mask.nii.gz
...
randomise -i negative_contrasts -o OneSampT_neg -1 -x -c `ptoz 0.005` -n 10000 -m /storage/essicd/data/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds109/FSL/LEVEL2/permutation_test/../group.gfeat/cope1.feat/mask.nii.gz
