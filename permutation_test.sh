...
3dclust -1Dformat -nosum -1dindex 1 -1tindex 1 -2thresh -1e+09 2.576 -savemask Positive_clust_mask -dxyz=1 1.01 1078 /home/maullz/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds109/AFNI/LEVEL2/permutation_test/ttest++_Clustsim_result+tlrc.HEAD
...
# Binarizing both cluster masks
   ...
   3dcalc -a Positive_binary_clust_mask+tlrc -b ttest++_Clustsim_result_t_stat_masked+tlrc \
