...
3dclust -1Dformat -nosum -1dindex 1 -1tindex 1 -2thresh -1e+09 2.326 -inmask -savemask Positive_clust_mask -dxyz=1 1.01 1117 /home/maullz/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds001/AFNI/LEVEL2/permutation_test/ttest++_Clustsim_result+tlrc.HEAD


3dclust -1Dformat -nosum -1dindex 1 -1tindex 1 -2thresh -2.326 1e+09 -inmask -savemask Positive_clust_mask -dxyz=1 1.01 1117 /home/maullz/NIDM-Ex/BIDS_Data/RESULTS/SOFTWARE_COMPARISON/ds001/AFNI/LEVEL2/permutation_test/ttest++_Clustsim_result+tlrc.HEAD

# Masking t_stat 
   3dcalc -a 'ttest++_Clustsim_result+tlrc[1]' -b 'mask+tlrc' \
            -expr 'a*b' -prefix ttest++_Clustsim_result_t_stat_masked -datum float   
...
# Binarizing both cluster masks
   ...
   3dcalc -a Positive_binary_clust_mask+tlrc -b 3ttest++_Clustsim_result_t_stat_masked+tlrc \
            -expr 'a*b' -prefix ttest++_Clustsim_result_positive_t_stat_clustered -datum float   

   3dcalc -a Negative_binary_clust_mask+tlrc -b ttest++_Clustsim_result_t_stat_masked+tlrc \
            -expr '-a*b' -prefix ttest++_Clustsim_result_negative_t_stat_clustered -datum float

# Convert to NIFTI for upload to Neurovault
  3dAFNItoNIFTI -prefix ttest++_Clustsim_result_t_stat ttest++_Clustsim_result+tlrc"[1]"
  3dAFNItoNIFTI ttest++_Clustsim_result_t_stat_masked+tlrc
  3dAFNItoNIFTI -prefix Positive_clustered_t_stat ttest++_Clustsim_result_positive_t_stat_clustered+tlrc
  3dAFNItoNIFTI -prefix Negative_clustered_t_stat ttest++_Clustsim_result_negative_t_stat_clustered+tlrc
