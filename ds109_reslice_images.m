...
fsl_perm_stat_file = fullfile(study_dir, 'FSL', 'LEVEL2', 'permutation_test', 'OneSampT_pos_tstat1.nii.gz');
gunzip(fullfile(study_dir, 'FSL', 'LEVEL2', 'permutation_test', '05FWECorrected_OneSampT_pos_exc_set.nii.gz'));
fsl_perm_pos_exc_file = fullfile(study_dir, 'FSL', 'LEVEL2', 'permutation_test', '05FWECorrected_OneSampT_pos_exc_set.nii.gz');
gunzip(fullfile(study_dir, 'FSL', 'LEVEL2', 'permutation_test', '05FWECorrected_OneSampT_neg_exc_set.nii.gz'));
fsl_perm_pos_exc_file = fullfile(study_dir, 'FSL', 'LEVEL2', 'permutation_test', '05FWECorrected_OneSampT_neg_exc_set.nii.gz');
...
[afni_perm_stat_dir, ~, ~] = fileparts(afni_perm_stat_file);
[fsl_perm_stat_dir, ~, ~] = fileparts(fsl_perm_stat_file);
[spm_perm_stat_dir, ~, ~] = fileparts(spm_perm_stat_file);
...
reslice_flags = struct('mask', true, 'mean', false, 'interp', 0, 'which', 1, 'wrap', [1 1 0], 'prefix', 'afni_fsl_');
spm_reslice({afni_perm_pos_exc_file_file, fsl_perm_pos_exc_file}, reslice_flags);
reslice_flags = struct('mask', true, 'mean', false, 'interp', 0, 'which', 1, 'wrap', [1 1 0], 'prefix', 'afni_fsl_');
spm_reslice({fsl_perm_pos_exc_file_file, afni_perm_pos_exc_file}, reslice_flags);
...
reslice_flags = struct('mask', true, 'mean', false, 'interp', 0, 'which', 1, 'wrap', [1 1 0], 'prefix', 'afni_fsl_');
spm_reslice({afni_perm_pos_exc_file_file, spm_perm_pos_exc_file}, reslice_flags);
reslice_flags = struct('mask', true, 'mean', false, 'interp', 0, 'which', 1, 'wrap', [1 1 0], 'prefix', 'afni_fsl_');
spm_reslice({spm_perm_pos_exc_file_file, afni_perm_pos_exc_file}, reslice_flags);
...
reslice_flags = struct('mask', true, 'mean', false, 'interp', 0, 'which', 1, 'wrap', [1 1 0], 'prefix', 'afni_fsl_');
spm_reslice({fsl_perm_pos_exc_file_file, spm_perm_pos_exc_file}, reslice_flags);
reslice_flags = struct('mask', true, 'mean', false, 'interp', 0, 'which', 1, 'wrap', [1 1 0], 'prefix', 'afni_fsl_');
spm_reslice({spm_perm_pos_exc_file_file, fsl_perm_pos_exc_file}, reslice_flags);
