function ds109_SPM_render
    ...
    batch = ds109_SPM_batch(POS_EXCURSION_SET_FILE, SPM_SURFACE_FILE);
    spm_jobman('run', batch)
end

function x = ds109_SPM_batch(POS_EXCURSION_SET_FILE, SPM_SURFACE_FILE)
	%-----------------------------------------------------------------------
