function ds001_FSL_render
    ...
    POS_EXCURSION_SET_FILE = fullfile(base_dir, 'figures', 'input', study, 'fsl_exc_set.nii.gz');
    NEG_EXCURSION_SET_FILE = fullfile(base_dir, 'figures', 'input', study, 'fsl_exc_set_neg.nii.gz');
