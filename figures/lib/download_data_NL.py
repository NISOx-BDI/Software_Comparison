...
def download_data_NL(nv_collection, study, output_dir):
    ...
    euler_char_files = (
            (os.path.join('AFNI_NL', 'LEVEL2', 'euler_chars.csv'), 'afni_euler_chars.csv'),
    ...
    if study not in ('ds120'):
        euler_char_files = (
            ...
            ((os.path.join('FSL_NL', 'LEVEL2', 'group.gfeat', 'cope1.feat', 'stats', 'euler_chars.csv'), 'fsl_euler_chars.csv'),) +
            ((os.path.join('FSL_NL', 'LEVEL2', 'permutation_test', 'euler_chars.csv'), 'fsl_perm_euler_chars.csv'),) +
            # There is no permutation analysis for ds120
            ((os.path.join('AFNI_NL', 'LEVEL2', 'permutation_test', 'euler_chars.csv'), 'afni_perm_euler_chars.csv'),) + 
