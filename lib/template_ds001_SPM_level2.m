...
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'pumps demean vs ctrl demean neg';
...
matlabbatch{4}.spm.stats.results.conspec(1).extent = 211;
...
matlabbatch{4}.spm.stats.results.conspec(2).extent = 262;
...
matlabbatch{4}.spm.stats.results.export{1}.nidm.group.nsubj = 16;
