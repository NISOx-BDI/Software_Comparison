...
matlabbatch{4}.spm.stats.results.conspec(1).thresh = 0.005;
matlabbatch{4}.spm.stats.results.conspec(1).extent = 657;
...
matlabbatch{4}.spm.stats.results.conspec(2).thresh = 0.005;
matlabbatch{4}.spm.stats.results.conspec(2).extent = 657;
matlabbatch{4}.spm.stats.results.conspec(2).conjunction = 1;
matlabbatch{4}.spm.stats.results.conspec(2).mask.none = 1;
matlabbatch{4}.spm.stats.results.units = 1;
matlabbatch{4}.spm.stats.results.export{1}.nidm.modality = 'FMRI';
matlabbatch{4}.spm.stats.results.export{1}.nidm.refspace = 'ixi';
matlabbatch{4}.spm.stats.results.export{1}.nidm.group.nsubj = 21;
matlabbatch{4}.spm.stats.results.export{1}.nidm.group.label = 'group';
matlabbatch{4}.spm.stats.results.export{2}.tspm.basename = 'thresholded';
