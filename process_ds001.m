...
CondNames = {...
    {'pumps_fixed','pumps_fixed_pmod'},...
    'pumps_RT',...
    {'cash_fixed','cash_fixed_pmod'},...
    'cash_RT',...
    {'explode_fixed','explode_fixed_pmod'},...
    {'control_pumps_fixed','control_pumps_fixed_pmod'},...,
    'control_pumps_RT'};

create_onset_files(study_dir, onsetDir, FSLonsetDir, CondNames)
