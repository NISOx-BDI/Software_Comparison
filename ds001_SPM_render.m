function ds001_SPM_render
    ...
    NEG_EXCURSION_SET_FILE = fullfile(base_dir, 'input', study, 'spm_exc_set_neg.nii.gz');
    SPM_SURFACE_FILE = fullfile(spm_dir, 'canonical', 'cortex_20484.surf.gii');

    batch = ds001_SPM_batch(POS_EXCURSION_SET_FILE, NEG_EXCURSION_SET_FILE, SPM_SURFACE_FILE);
    spm_jobman('run', batch)
end

function x = ds001_SPM_batch(POS_EXCURSION_SET_FILE, NEG_EXCURSION_SET_FILE, SPM_SURFACE_FILE)
	%-----------------------------------------------------------------------
